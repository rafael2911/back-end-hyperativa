...
public abstract class CardBatchEntityMapper {
    ...
    @Mapping(target = "loteNumber", source = "file", qualifiedByName = "extractBatchNumberFromFile")
    public abstract CardBatchEntity fromBatchUploadRequestDTO(BatchUploadRequestDTO source);
